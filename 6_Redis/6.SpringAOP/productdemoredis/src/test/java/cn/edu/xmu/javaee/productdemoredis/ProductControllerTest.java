...
@SpringBootTest(classes = ProductDemoRedisApplication.class)
...
public class ProductControllerTest {
    ...
    @Test
    public void getProductGivenNonExistId1() throws Exception {
    ...
    @Test
    public void getProductGivenNonExistId2() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(PRODUCTID, 1550122))
                .andExpect(MockMvcResultMatchers.status().isNotFound());
        //.andDo(MockMvcResultHandlers.print());
    ...
    @Test
    public void searchProductByNameGivenNonExistName1() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(PRODUCT).contentType("application/json;charset=UTF-8")
                        .param("name", "奥"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType("application/json;charset=UTF-8"))
    ...
    @Test
    public void searchProductByNameGivenNonExistName2() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.get(PRODUCT).contentType("application/json;charset=UTF-8")
                        .param("name", "奥"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType("application/json;charset=UTF-8"))
